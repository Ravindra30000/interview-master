        ...
        <section className="py-20 md:py-32 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Practice with 4,000+ real interview questions across 73 roles and
              12+ domains, get instant AI feedback, and track your progress.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                4,000+ Real Questions
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Practice with questions from 73 roles across 12+ domains
                including Engineering, Business, Data & Analytics, Design,
                Finance, Marketing & Sales, Cybersecurity, Healthcare, and more.
                Questions are categorized by difficulty and include answer
                frameworks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Get instant feedback from Google Gemini AI on your answers.
                Receive scores, detailed feedback, and actionable improvements
                to enhance your interview performance.
              </p>
            </div>

            {/* Feature 2.5 - Avatar Interview Mode */}
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Practice with an AI interview coach avatar. Experience realistic
                conversations with pre-recorded videos, natural voice synthesis,
                and real-time feedback. Perfect for simulating actual interview
                scenarios.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Record your practice sessions with automatic video compression.
                Review your performance, body language, and delivery to identify
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Automatic speech-to-text transcription captures your answers in
                real-time. Review your responses and see exactly what you said
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                Track scores, review past sessions, and identify patterns in
                your performance.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Your practice sessions are stored securely with Firebase. All
                videos and transcripts are private to your account. Practice
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>4,000+ Interview Questions</li>
                <li>73 Roles Across 12+ Domains</li>
                <li>Avatar Interview Mode</li>
                <li>AI-Powered Feedback</li>
                <li>Multimodal Video Analysis</li>
